    ...
    <div className="card bg-card mx-auto thin-border rounded-xl overflow-hidden shadow-lg">
      ...
      <div className="px-6 py-4 card-body">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="bg-type text-gray-200">{course.type}</button>
        </div>
        {/* title */}
          ...
          <div className="flex gap-2 justify-start items-center teacher-detail py-2 md:py-3 lg:py4 xl:py-5">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-gray-300/90">
                فرانت اند دولپر در ماکروسافت
              </p>
            </div>
          </div>

          {/* price and more info */}
          <div className="flex items-center justify-around gap-2 -mx-2 pt-4 pb-2">
            <button className="flex rounded-lg whitespace-nowrap text-sm lg:arrow-btn items-center bg-gradient px-3 py-3">
